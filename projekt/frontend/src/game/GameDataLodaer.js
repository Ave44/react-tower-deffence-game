...
const GameDataLoader = () => {
    ...
    useEffect(()=> {
        setAllTowers({archers: {label: "archers", name: "Archers", img: "archers", range: 2, minDamage: 1, maxDamage: 4, type: 'physical', cost: 80, speed: 2,
            ...
            forestArchers: {label: 'forestArchers', name: 'Forest Archers', img: 'forestArchers', range: 4, minDamage: 3, maxDamage: 5, type: 'physical', speed: 1, cost: 150},
            ...
            eliteArchers: {label: 'eliteArchers', name: 'Elite Archers', img: 'eliteArchers', range: 5, minDamage: 16, maxDamage: 22, type: 'physical', speed: 1, cost: 450},
            ...
            elitePicinieres: {label: 'elitePicinieres', name: 'Elite Picinieres', img: 'elitePicinieres', range: 2, minDamage: 30, maxDamage: 36, speed: 1, type: 'physical', cost: 500}})
